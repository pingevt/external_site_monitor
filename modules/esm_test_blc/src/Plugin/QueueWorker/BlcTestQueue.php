...
namespace Drupal\esm_test_blc\Plugin\QueueWorker;
...
/**
 * Continue tests that are ready to go.
 *
 * @QueueWorker(
 *   id = "esm_test_blc.continue_tests",
 *   title = @Translation("Continue Broken Link Checker"),
 * )
 */
class BlcTestQueue extends QueueWorkerBase implements ContainerFactoryPluginInterface {
