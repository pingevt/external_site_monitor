...
namespace Drupal\esm_test_pchr\Form;
...
class PchrTestSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'esm_test_pchr_wpt_test_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['branch'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Branch'),
      '#default_value' => $this->config('esm_test_pchr.settings')->get('branch'),
    ];
    ...
    $form['api_url'] = [
      ...
      '#default_value' => $this->config('esm_test_pchr.settings')->get('api_url'),
    ];

    // Github Token.
    $key = NULL;
    if ($this->config('esm_test_pchr.settings')->get('github_token')) {
      $key_storage = $this->entityTypeManager->getStorage("key");
      $key = $key_storage->load($this->config('esm_test_pchr.settings')->get('github_token'));
    }
    ...
    $form['dir'] = [
      ...
      '#default_value' => $this->config('esm_test_pchr.settings')->get('dir'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('esm_test_pchr.settings')
